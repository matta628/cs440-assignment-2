...
int main() {
  ...
  const char *stl = demangle(typeid(std::map<int,int>));

  {
    dispTestName("STL map ascending insert", stl);
    ascendingInsert<std::map<int,int>>(1000);
    ascendingInsert<std::map<int,int>>(10000);
    ascendingInsert<std::map<int,int>>(100000);
    ascendingInsert<std::map<int,int>>(1000000);
    ascendingInsert<std::map<int,int>>(10000000);
